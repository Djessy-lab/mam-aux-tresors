...
const Equipe = () => {
  ...
  return (
    <div className=''>
      <h1 className="text-[#636e6d] text-center text-5xl p-10 mt-10 font-serif font-bold">Qui sommes nous ?</h1>
      <div className="lg:flex lg:justify-around flex-1 mt-32">
        {equipe.map((member, index) => (
          ...
          >
            <div className='cursor-pointer' onClick={() => handleCardClick(index)}>
              <animated.div
                className="flex justify-center shadow-lg hover:shadow-md rounded-xl p-10 w-[25vw] "
                style={{ ...springProps }}
              >
                <div className="flex flex-col items-center">
                  ...
                  <div className="shadow-md rounded-xl p-4 bg-[#AABEBD] min-w-48 max-w-48">
                    <h2 className="text-center text-3xl text-white font-serif">{member.nom}</h2>
                  </div>
                </div>
              </animated.div>
            </div>
            <div onClick={() => handleCardClick(index)}>
              <animated.div
                ...
                style={{ ...springProps }}
              >
                <div className="flex flex-col justify-around items-center min-h-60 max-h-60">
                  <div className="">
                    <p className='text-center text-[#738180]'>{member.description}</p>
                  </div>
                  <a href={`tel:${member.tel}`} className="text-center text-3xl text-white font-serif" onClick={handleTelClick}>
                    <div className="shadow-md rounded-xl p-4 bg-[#AABEBD] hover:bg-[#5c6766] min-w-48 max-w-48">
                      {member.tel}
                    </div>
                  </a>
                </div>
